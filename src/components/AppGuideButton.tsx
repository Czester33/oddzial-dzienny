...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Usunięta osoba znika z listy, ale jej dane zostają w archiwum (urlopy, przyjęcia, masaże — widać tam nadal jej imię i kolor).",
      "Na dole strony: „Przywróć usuniętego fizjoterapeutę” — możesz przywrócić kogoś z listy. Przywrócona osoba wraca z tym samym kolorem i ID.",
      "„Usuń trwale” kasuje profil na stałe (po potwierdzeniu). Stare wpisy w archiwum zostają, ale bez kafelka tej osoby.",
