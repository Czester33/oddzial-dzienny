...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Ręczne numerowanie (wpisujesz „1.”, „2.”…): Enter na linii z numerem → następna linia z kolejnym numerem. Po przerwie: wpisz „1.” i spację — podpowie następny numer.",
      "Tab = wcięcie (podpunkt). Shift+Tab = cofnij wcięcie.",
