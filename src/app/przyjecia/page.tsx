...
import { placePatientInFreeSlot, clearPatientSlot, physioShortName, physiosForSelect } from "@/lib/physio-utils";
                ...
                <tr key={slot.id} id={`admission-slot-${slot.id}`}>
                  ...
                  >
                    <PhysioSelect
                      ...
                      options={physiosForSelect(data, slot.physiotherapistId).map((p) => ({
                        value: p.id,
